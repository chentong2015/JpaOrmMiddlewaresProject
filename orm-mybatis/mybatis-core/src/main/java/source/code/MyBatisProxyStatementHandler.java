...
public class MyBatisProxyStatementHandler implements StatementHandler {

    private final StatementHandler statementHandler;

    public MyBatisProxyStatementHandler(StatementHandler statementHandler) {
        this.statementHandler = statementHandler;
    }

    public MyBatisProxyStatementHandler(Executor executor, MappedStatement ms, Object parameter, RowBounds rowBounds, ResultHandler resultHandler, BoundSql boundSql) {
