package hibernate.framework.apis.query_hql.select_filter;
...
public class FilterSelectDemo {
    ...
    private static void testFilterSelection(Session session) {
        session.disableFilter("incomeLevelFilter"); // 取消Filter的激活效果
        session.enableFilter("incomeLevelFilter").setParameter("incomeLimit", 200);
